...
#ifndef HA_FONA_LARA_LIBRARY_SRC_INCLUDES_PLATFORM_FONAPLATFORM_H_
#define HA_FONA_LARA_LIBRARY_SRC_INCLUDES_PLATFORM_FONAPLATFORM_H_

#include "../HA_FONA_LARAConfig.h"

// only "standard" config supported in this release -- namely AVR-based arduino type affairs
#include "HA_FONA_LARAPlatStd.h"
...
#endif /* HA_FONA_LARA_LIBRARY_SRC_INCLUDES_PLATFORM_FONAPLATFORM_H_ */
